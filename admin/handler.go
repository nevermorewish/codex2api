...
func (h *Handler) RegisterRoutes(r *gin.Engine) {
	...
	api.GET("/live-streams/:stream_id", h.GetLiveStreamDetail)
	api.GET("/live-streams/:stream_id/requests", h.GetLiveStreamRequests)
	api.GET("/live-stream-requests/:request_id/attempts", h.GetLiveStreamRequestAttempts)
