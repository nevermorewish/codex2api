...
export default function Usage() {
  ...
  }, [timeRange, customRange, searchQuery, filterModel, filterEndpoint, filterApiKeyId, filterAccountId, filterFast, filterUltra, filterType, activeChannel, filterRetry, filterTransport])
  ...
  const modelFilterOptions = useMemo(() => {
    ...
    return merged
  }, [modelOptions, grokModelOptions, claudeModelOptions, seenModels, activeChannel, filterModel])
